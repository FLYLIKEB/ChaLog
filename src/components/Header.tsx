...
export function Header({ title, showBack, onBack, showProfile, showLogo }: HeaderProps) {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-[100] bg-card/70 backdrop-blur-md border-b border-border/50 rounded-b-2xl py-3 pt-[calc(0.75rem+env(safe-area-inset-top))]">
