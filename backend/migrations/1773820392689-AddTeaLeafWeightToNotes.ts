...
export class AddTeaLeafWeightToNotes1773820392689 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`email_verification_tokens\` DROP FOREIGN KEY \`FK_email_verification_tokens_userId\``);
        ...
        await queryRunner.query(`DROP INDEX \`IDX_email_verification_tokens_tokenHash\` ON \`email_verification_tokens\``);
        await queryRunner.query(`DROP INDEX \`IDX_email_verification_tokens_userId\` ON \`email_verification_tokens\``);
        await queryRunner.query(`DROP INDEX \`UQ_6ffc7f32577cfaecd29504e5162\` ON \`email_change_tokens\``);
        ...
        await queryRunner.query(`ALTER TABLE \`email_verification_tokens\` ADD UNIQUE INDEX \`IDX_90489f8f3368c45f461e90efbe\` (\`tokenHash\`)`);
        await queryRunner.query(`ALTER TABLE \`email_change_tokens\` DROP COLUMN \`tokenHash\``);
        await queryRunner.query(`ALTER TABLE \`email_change_tokens\` ADD \`tokenHash\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`email_change_tokens\` ADD UNIQUE INDEX \`IDX_6ffc7f32577cfaecd29504e516\` (\`tokenHash\`)`);
        await queryRunner.query(`ALTER TABLE \`email_change_tokens\` CHANGE \`createdAt\` \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`email_change_tokens\` CHANGE \`createdAt\` \`createdAt\` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE \`email_change_tokens\` DROP INDEX \`IDX_6ffc7f32577cfaecd29504e516\``);
        await queryRunner.query(`ALTER TABLE \`email_change_tokens\` DROP COLUMN \`tokenHash\``);
        await queryRunner.query(`ALTER TABLE \`email_change_tokens\` ADD \`tokenHash\` varchar(64) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`email_verification_tokens\` DROP INDEX \`IDX_90489f8f3368c45f461e90efbe\``);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`UQ_6ffc7f32577cfaecd29504e5162\` ON \`email_change_tokens\` (\`tokenHash\`)`);
        await queryRunner.query(`CREATE INDEX \`IDX_email_verification_tokens_userId\` ON \`email_verification_tokens\` (\`userId\`)`);
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_email_verification_tokens_tokenHash\` ON \`email_verification_tokens\` (\`tokenHash\`)`);
        ...
        await queryRunner.query(`ALTER TABLE \`email_verification_tokens\` ADD CONSTRAINT \`FK_email_verification_tokens_userId\` FOREIGN KEY (\`userId\`) REFERENCES \`users\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
