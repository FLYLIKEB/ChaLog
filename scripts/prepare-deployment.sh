...
echo ""
echo "필수 Secrets:"
echo "  [ ] EC2_HOST: YOUR_LIGHTSAIL_IP (Lightsail Public IP)"
...
echo "  1. Health check: curl http://YOUR_LIGHTSAIL_IP:3000/health"
echo "  2. PM2 상태: 브라우저 SSH에서 'pm2 status' 실행"
echo "  3. Nginx 설정: ./scripts/setup-nginx.sh YOUR_LIGHTSAIL_IP"
echo ""
